...
Run:
    export API_KEY=sk-...
    python3 -m py.examples.ohttp_client                                # all examples
    python3 -m py.examples.ohttp_client --model anthropic/claude-haiku-4-5
    python3 -m py.examples.ohttp_client --verify-attestation           # check key is TEE-attested
